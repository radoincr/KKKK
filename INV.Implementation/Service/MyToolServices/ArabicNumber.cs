...
public class ArabicNumber
{
    ...
    public string arabicNumber(double num)
    {
        ...
        var num6 = (int)(num / 1_000_000);
        var num4 = (int)(num % 1_000_000 / 1000);
        var num3 = (int)(num % 1000 / 100);
        var num2 = (int)(num % 100 / 10);
        var num1 = (int)(num % 10);

        var result = "";

        if (num6 > 0)
            result += (num6 == 1 ? aname1000000[1] :
                num6 == 2 ? aname1000000[2] : arabicNumber(num6) + " " + aname1000000[3]) + " ";

        if (num4 > 0)
            result += (num4 == 1 ? aname1000[1] : num4 == 2 ? aname1000[2] : arabicNumber(num4) + " " + aname1000[3]) +
                      " ";

        if (num3 > 0) result += aname100[num3] + " ";
