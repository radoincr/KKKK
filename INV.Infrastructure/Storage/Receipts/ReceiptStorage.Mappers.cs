...
public partial class ReceiptStorage
{
    ...
    private static ReceiptInfo GetReceiptInfoFromDataRow(DataRow row)
    {
        return new ReceiptInfo
        {
            ...
            Date = row.IsNull("Date") ? null : DateOnly.FromDateTime((DateTime)row["Date"]),
            ...
            DeliveryDate = row.IsNull("DeliveryDate") ? null : DateOnly.FromDateTime((DateTime)row["DeliveryDate"]),
